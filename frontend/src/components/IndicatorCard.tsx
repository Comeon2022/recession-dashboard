...
export function IndicatorCard({ indicator }: { indicator: Indicator }) {
  ...
  const comparison: Comparison[] = [
    historicalCell('Today', historical?.today, card.primaryValue),
    historicalCell('2020', historical?.recession_2020, 'N/A'),
    historicalCell('2008', historical?.recession_2008, 'N/A'),
    historicalCell('2001', historical?.recession_2001, 'N/A'),
  ];
